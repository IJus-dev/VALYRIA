...
export const chartTheme = {
  axis: colorVariable("dusk", "0.74"),
  grid: colorVariable("ink", "0.08"),
  line: colorVariable("clay", "1"),
  dot: colorVariable("moss", "1"),
  activeDot: colorVariable("ink", "1"),
  tooltipBackground: colorVariable("paper", "0.96"),
  tooltipBorder: `1px solid ${colorVariable("ink", "0.08")}`,
  tooltipRadius: "var(--radius-tile)"
} as const;
