...
function buttonClasses(variant: ButtonVariant = "default", size: ButtonSize = "md", className?: string) {
  return cn(
    "inline-flex items-center justify-center gap-2 rounded-pill font-semibold transition duration-200 ease-fluent focus:outline-none focus:ring-4 focus:ring-moss/10 disabled:cursor-not-allowed disabled:opacity-60",
    ...
    variant === "ghost" && "border border-line/55 bg-paper/75 text-dusk hover:bg-paper/90",
    className
  );
}
